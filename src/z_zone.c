...
// TODO:INVESTIGATE
// So I think memzone_t is really just a header for the rest of the memory
// And when we set blocklist.next and blocklist.prev they get set to immediately
// after the header
typedef struct {
...
void* Z_Malloc(int size, int tag, void* user) {
    ...
    // TODO:INVESTIGATE
    // At first glance this doesn't seem to do anything
    // What is it doing?
    size = (size + 3) & ~3;
